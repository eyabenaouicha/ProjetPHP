        ...
        <div class="home-content" style="width: 147%!important;">
            ...
            <div class="sales-boxes">
                <div class="recent-sales box">
                                            ...
                                            <div class="form_wrap">
                                                <div class="input_grp">
                                                        ...
                                                        <input type="hidden" placeholder="id" name="inputid" id="inputid" value="<?php echo $row["id"]?>">
                                                            ...
                                                            <input type="text" id="ftype" name="inputtype" value="<?php echo $row["type"]?>">
                                                        </div>
                    ...
                    <div class="button">
                        <a href="#"><input type="submit" value="Modifier" class="submit_btn" style="background: #0d6bd700;border:none;color:white">
</a>
                    </div>
                    </form>
                            </div>
