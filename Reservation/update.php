...
if (!empty($_POST)) {
    ...
    $pdostmtadd->execute(["idUtilisateur" => $_POST["inputUtilisateur"], "idChambre" => $_POST["inputChambre"], "iddateDebut" => $_POST["inputdateDebut"], "dateFin" => $_POST["inputdateFin"], "formule" => $_POST["inputformule"], "facture" => $_POST["inputidFacture"], "etat" => $_POST["inputetat"], "id" => $_POST["inputid"]]);
...
<body>
    ...
    <section class="home-section">
        ...
        <div class="home-content">
            ...
            <?php
            if (!empty($_GET["id"])) {
                $queryup = "select * from reservation where id=:id";
                $pdostmtup = $pdo->prepare($queryup);
                $pdostmtup->execute(["id" => $_GET["id"]]);
                $row = $pdostmtup->fetch(PDO::FETCH_ASSOC);
            }
            ?>
            <div class="wrapper">
                        ...
                        <div class="form_wrap">
                            <div class="input_grp">
                                ...
                                <div class="input_wrap">
                                    ...
                                    <input type="text" id="ftype" name="inputidFacture" value="<?php echo $row["idFacture"] ?>">
                                </div>
                                <div class="input_wrap">
