                    ...
                    <div class="wrapper" style="margin-left: 20%;">
                        ...
                        <div class="form">
                            <div class="inputfield">
                                ...
                                <input type="text" name="inputnum" class="input" value="<?php echo $row["num"] ?>">
                            </div>
                            <div class="inputfield">
                                <label>Price</label>
                                <input type="text" name="inputprix" class="input" value="<?php echo $row["prix"] ?>">
                            </div>
                            <div class="inputfield">
                                <?php
                                // $pdo = new connect();
                            ...
                            <div class="inputfield">
                                <a href="#"><input type="submit" name="submit" value="Modify Room" class="btn">
                                </a>
                            </div>
                        </div>
                    </div>
